...
1. Run the publish script to assemble both page versions:
   ...
   ```
2. Verify the generated files in `pages/` look correct (postamble after story content, copyright at bottom of full version; postamble but no copyright in medium version).
